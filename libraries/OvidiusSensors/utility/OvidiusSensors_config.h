...
#define TOTAL_ACTIVE_JOINTS     3       // [9-4-21] yet!
#define MAX_TRAJ_POINTS1        10      // [28-7-21] Will be removed, not right place here 
#define MAX_TRAJ_POINTS2        30      //  --//-- 
...
#define DOUT_PIN_X              38 // 38 - 11
#define SCK_PIN_X               39 // 39 - 12
#define DOUT_PIN_Y              32
#define SCK_PIN_Y               33
#define DOUT_PIN_Z              42
#define SCK_PIN_Z               43
#define SENSOR_TIMEOUT          500
#define TIMEOUT_DELAY_MS        10
...
// SD card read/write
#define MAX_LOG_DATA            100    // [9-4-21]  IS USED FOR STATIC MEMORY PREALLOCATION FOR THE TOTAL DATA TO BE LOGGED DURING EACH TASK
